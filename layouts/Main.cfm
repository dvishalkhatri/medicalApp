		...
		<body>
			<div id="app">
					...
					<div class="sidebar-wrapper active">
						<div class="sidebar-header position-relative">
							<div class="d-flex justify-content-between align-items-center">
								<div class="logo">
									<a href="index.html"><img src="/includes/assets/images/logo/logo.svg" alt="Logo" srcset=""></a>
								</div>
				...
				<div id="main">
													...
													<div class="col-6">
														<div class="d-flex align-items-center">
															<svg class="bi text-primary" width="32" height="32" fill="blue"
																style="width:10px">
																<use
																	xlink:href="/includes/assets/images/bootstrap-icons.svg##circle-fill" />
															</svg>
														...
														<tbody>
																...
																<td class="col-3">
																	<div class="d-flex align-items-center">
																		<div class="avatar avatar-md">
																			<img src="/includes/assets/images/faces/5.jpg">
																		</div>
															...
															<tr>
																<td class="col-3">
																	<div class="d-flex align-items-center">
																		<div class="avatar avatar-md">
																			<img src="/includes/assets/images/faces/2.jpg">
																		</div>
									...
									<div class="card-body py-4 px-4">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-xl">
												<img src="/includes/assets/images/faces/1.jpg" alt="Face 1">
											</div>
											<div class="ms-3 name">
									...
									<div class="card-content pb-4">
										<div class="recent-message d-flex px-4 py-3">
											<div class="avatar avatar-lg">
												<img src="/includes/assets/images/faces/4.jpg">
											</div>
											<div class="name ms-4">
										...
										<div class="recent-message d-flex px-4 py-3">
											<div class="avatar avatar-lg">
												<img src="/includes/assets/images/faces/1.jpg">
											</div>
											<div class="name ms-4">
					...
					<!--- <div class="hummingbird-treeview-converter" data-height="100%" data-scroll="false" data-id="_movies" data-css="overflow-x:scroll; background-color:coral;">
